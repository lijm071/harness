...
from coding_agent.metrics import (  # noqa: E402
...
def build_arg_parser():
    parser = argparse.ArgumentParser(description="Run coding-agent large-scale experiments and write all experiment artifacts.")
